...
public:
	AttackData();
	AttackData(const AttackDataBase& ADB,int P_Id,int B_Id, GameSkill* pWeapon);
	AttackData(const AttackDataBase& ADB,int P_Id,const GridPos& GPos, GameSkill* pWeapon);
